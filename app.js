...
$(document).ready(function() {
  ...
  //   $(this).children('div.notes').slideDown(300);
  // });
  ...
  $('input:text#filter-library').on('keyup', function() {
    var userInput = $('input:text#filter-library').val();
    if ($('input:text#filter-library').val() == "") {
      $('li').show();
    } else if ($("span.title:contains('" + userInput + "')")) {
      $("span.title:not(:contains('" + userInput + "'))").parent('li').hide();
    }
  });
